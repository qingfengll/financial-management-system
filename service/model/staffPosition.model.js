var staffPositionModel = {
    staffPosition:{
        ...
        add: 'INSERT INTO staff_position (position_id,position_name,base_pay,remark) VALUES (?,?,?,?)',
        update_position: 'UPDATE staff_position SET position_name=?, base_pay=?,remark=? WHERE (position_id=?)',
